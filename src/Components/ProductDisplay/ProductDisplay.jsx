...
const ProductDisplay = (props) => {
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-neutral-900 via-slate-900 to-violet-900">
        <Navbar></Navbar>
        <div className="pt-6">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              <h2 className="sr-only text-white">Products information</h2>
                    ...
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        ...
                        className={classNames(
                          reviews.average > rating ? "text-white" : "text-gray",
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active, checked }) =>
                            classNames(
                              ...
                              "relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 focus:outline-none border"
                            )
                          }
                        >
                          <RadioGroup.Label
                        ...
                        <RadioGroup.Option
                          ...
                          className={({ active }) =>
                            classNames(
                              ...
                              "group relative flex items-center justify-center rounded-md border py-3 px-4 text-sm font-medium uppercase hover:bg-gray-300 focus:outline-none sm:flex-1 sm:py-6"
                            )
                          }
                        >
                          {({ active, checked }) => (
